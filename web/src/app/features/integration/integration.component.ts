      ...
      <div style="display:grid;grid-template-columns:minmax(0,3fr) minmax(0,2fr);gap:24px">
        ...
        <div style="display:flex;flex-direction:column;gap:16px">
          <div class="card" style="padding:20px">
            ...
            <div class="hrow"><span class="muted small">{{ 'last_sync' | t : 'Last sync' }}</span><span class="mono" style="flex:1;text-align:end">{{ c.lastSyncAt ? (c.lastSyncAt | date:'dd/MM/yyyy HH:mm') : ('never_executed' | t : 'Never executed') }}</span></div>
