  ...
  template: `
    ...
    <div class="card" style="padding:16px;margin-bottom:16px">
      <div class="frm-grid" style="grid-template-columns:repeat(6,1fr);gap:12px;align-items:end">
        ...
        <div class="field"><label>{{ 'reg_branch' | t : 'Reg branch' }}</label><app-filter-select [multiple]="true" [options]="branches()" [ngModel]="branch()" (ngModelChange)="branch.set($event)" [placeholder]="'all' | t : 'All'"></app-filter-select></div>
