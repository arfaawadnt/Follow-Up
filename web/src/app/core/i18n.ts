...
const EN: Dict = {
  ...
  'nav.users': 'Users', 'nav.setup': 'Setup', 'nav.labcheckin': 'Lab Check-in', 'nav.sampletracking': 'Sample Tracking',
  'nav.analytics': 'Analytics', 'nav.settings': 'Settings', 'nav.testcatalogue': 'Test Catalogue',
...
const AR: Dict = {
  ...
  'nav.users': 'المستخدمون', 'nav.setup': 'الإعدادات', 'nav.labcheckin': 'استلام المعمل', 'nav.sampletracking': 'تتبع العينات',
  'nav.analytics': 'التحليلات', 'nav.settings': 'الإعدادات العامة', 'nav.testcatalogue': 'دليل التحاليل',
