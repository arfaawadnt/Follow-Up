...
public static class AdminEndpoints
{
    ...
    public static void MapSetupEndpoints(this RouteGroupBuilder api)
    {
        ...
        { await m.Send(new UpdateCityCommand(id, b.Name, b.Governorate, b.RealName), ct); return Results.NoContent(); }).WithTags("Setup");
        ...
        { await m.Send(new UpdateAreaCommand(id, b.Name, b.CityId, b.TransportationRequired, b.RealName, b.AreaManagerId, b.AreaResponsibleId), ct); return Results.NoContent(); }).WithTags("Setup");
