...
public sealed class TreasuryGrantIdConverter : ValueConverter<FollowUp.Domain.Accounting.TreasuryGrantId, Guid> { public TreasuryGrantIdConverter() : base(x => x.Value, v => new FollowUp.Domain.Accounting.TreasuryGrantId(v)) { } }
...
public sealed class SupplierIdConverter : ValueConverter<FollowUp.Domain.Inventory.SupplierId, Guid> { public SupplierIdConverter() : base(x => x.Value, v => new FollowUp.Domain.Inventory.SupplierId(v)) { } }
public sealed class StoreIdConverter : ValueConverter<FollowUp.Domain.Inventory.StoreId, Guid> { public StoreIdConverter() : base(x => x.Value, v => new FollowUp.Domain.Inventory.StoreId(v)) { } }
public sealed class InventoryItemIdConverter : ValueConverter<FollowUp.Domain.Inventory.InventoryItemId, Guid> { public InventoryItemIdConverter() : base(x => x.Value, v => new FollowUp.Domain.Inventory.InventoryItemId(v)) { } }
public sealed class ItemTestLinkIdConverter : ValueConverter<FollowUp.Domain.Inventory.ItemTestLinkId, Guid> { public ItemTestLinkIdConverter() : base(x => x.Value, v => new FollowUp.Domain.Inventory.ItemTestLinkId(v)) { } }
public sealed class PurchaseOrderIdConverter : ValueConverter<FollowUp.Domain.Inventory.PurchaseOrderId, Guid> { public PurchaseOrderIdConverter() : base(x => x.Value, v => new FollowUp.Domain.Inventory.PurchaseOrderId(v)) { } }
public sealed class PurchaseOrderLineIdConverter : ValueConverter<FollowUp.Domain.Inventory.PurchaseOrderLineId, Guid> { public PurchaseOrderLineIdConverter() : base(x => x.Value, v => new FollowUp.Domain.Inventory.PurchaseOrderLineId(v)) { } }
public sealed class GoodsReceiptIdConverter : ValueConverter<FollowUp.Domain.Inventory.GoodsReceiptId, Guid> { public GoodsReceiptIdConverter() : base(x => x.Value, v => new FollowUp.Domain.Inventory.GoodsReceiptId(v)) { } }
public sealed class GoodsReceiptLineIdConverter : ValueConverter<FollowUp.Domain.Inventory.GoodsReceiptLineId, Guid> { public GoodsReceiptLineIdConverter() : base(x => x.Value, v => new FollowUp.Domain.Inventory.GoodsReceiptLineId(v)) { } }
public sealed class StockLotIdConverter : ValueConverter<FollowUp.Domain.Inventory.StockLotId, Guid> { public StockLotIdConverter() : base(x => x.Value, v => new FollowUp.Domain.Inventory.StockLotId(v)) { } }
public sealed class StockMovementIdConverter : ValueConverter<FollowUp.Domain.Inventory.StockMovementId, Guid> { public StockMovementIdConverter() : base(x => x.Value, v => new FollowUp.Domain.Inventory.StockMovementId(v)) { } }
public sealed class StockTransferIdConverter : ValueConverter<FollowUp.Domain.Inventory.StockTransferId, Guid> { public StockTransferIdConverter() : base(x => x.Value, v => new FollowUp.Domain.Inventory.StockTransferId(v)) { } }
public sealed class StockTransferLineIdConverter : ValueConverter<FollowUp.Domain.Inventory.StockTransferLineId, Guid> { public StockTransferLineIdConverter() : base(x => x.Value, v => new FollowUp.Domain.Inventory.StockTransferLineId(v)) { } }
